...
export const CERTS = [
  {
    ...
    iconColor: '#a78bfa', iconBg: 'rgba(124,58,237,.18)',
  ...
  },
  {
    ...
    iconColor: '#f87171', iconBg: 'rgba(239,68,68,.18)',
  ...
  },
  {
    ...
    iconColor: '#67e8f9', iconBg: 'rgba(6,182,212,.18)',
    title: 'Relator Informático REUF SENCE',
    inst: 'SENCE Chile',
    date: 'Aprobado Oct 2025 · Hacking Ético, Redes, Cloud, Vue',
  },
  {
    fa: 'fa-brands fa-react',
    iconColor: '#38bdf8', iconBg: 'rgba(56,189,248,.18)',
    title: 'Master en React: ReactJS, Hooks, MERN, NodeJS, JWT+',
    inst: 'Udemy · Víctor Robles',
    date: 'Jun 2026 · 39.5 horas',
  },
  {
    fa: 'fa-brands fa-python',
    iconColor: '#fde68a', iconBg: 'rgba(253,230,138,.15)',
    title: 'Master en Python: Python 3, Django, Flask y Tkinter',
    inst: 'Udemy · Víctor Robles',
    date: 'Jun 2026 · 30.5 horas',
  },
  {
    fa: 'fa-solid fa-server',
    iconColor: '#6ee7b7', iconBg: 'rgba(16,185,129,.18)',
    title: 'Publicar webs en Internet: Hosting y VPS',
    inst: 'Udemy · Víctor Robles',
